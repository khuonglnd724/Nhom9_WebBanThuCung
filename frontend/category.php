...
<head>
  ...
  <title>Phụ kiện - StarryPets</title>
...
<body>
    ...
    <div class="container header-inner">
      ...
      <nav class="main-nav" id="mainNav">
        <ul class="menu">
          ...
          <li class="active"><a href="category.php">Phụ kiện</a></li>
  ...
  <main>
    ...
    <section class="hero container">
      <div class="hero-left">
        <h1>Phụ kiện thú cưng chất lượng</h1>
        <p>Tất cả những gì thú cưng bạn cần – từ chuồng đến áo, vòng cổ và đồ chơi</p>
    ...
    <section class="breadcrumb container">
      <span>Trang chủ</span> <span class="sep">|</span> <span>Phụ kiện</span>
    </section>

    <!-- Products (populated from site content) -->
    <section id="products" class="container products-section">
      <h2 class="section-title">DANH SÁCH PHỤ KIỆN</h2>
      ...
      <div class="products-grid">
        ...
        <article class="product-card">
          ...
          <div class="actions">
            ...
            <button class="btn btn-outline view-product-btn" data-id="phoc-soc" data-name="PHỐC SÓC BÉ XÍU CƯNG XĨU" data-price="20.000.000₫" data-image="https://placehold.co/600x500?text=PHOC+SOC">Xem</button>
          </div>
        </article>
        ...
        <article class="product-card">
          ...
          <div class="actions">
            ...
            <button class="btn btn-outline view-product-btn" data-id="samoyed-trang" data-name="SAMOYED TRẮNG TINH XINH YÊU" data-price="16.000.000₫" data-image="https://placehold.co/600x500?text=SAMOYED+TRANG">Xem</button>
          </div>
        </article>
        ...
        <article class="product-card">
          ...
          <div class="actions">
            ...
            <button class="btn btn-outline view-product-btn" data-id="meo-golden-lun" data-name="MÈO GOLDEN LÙN" data-price="21.000.000₫" data-image="https://placehold.co/600x500?text=MEO+GOLDEN+LUN">Xem</button>
          </div>
        </article>
