...
<head>
  ...
  <title>Mèo Tai Cụp - StarryPets</title>
...
<body>
  ...
  <main>
    ...
    <section class="breadcrumb container">
      <span>Trang chủ</span> <span class="sep">|</span> <span>Mèo Tai Cụp</span>
    </section>

    <!-- Content Section -->
    <section class="container" style="margin: 40px 0; padding: 40px 0;">
      <h1 style="font-size: 32px; margin-bottom: 20px; color: #333;">Mèo Tai Cụp</h1>
      <p style="font-size: 16px; line-height: 1.8; color: #666;">Trang thông tin về giống mèo tai cụp.</p>
    </section>
  </main>
