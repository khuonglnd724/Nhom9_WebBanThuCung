...
<body>
  ...
  <main>
    ...
    <section class="hero container">
      <div class="hero-left">
        <h1>Về StarryPets</h1>
        <p>Chúng tôi là đối tác tin cậy trong việc chăm sóc và bán thú cưng chất lượng cao</p>
        <a class="btn btn-primary" href="gioithieu.php">Tìm hiểu thêm</a>
      </div>
    ...
    <section class="breadcrumb container">
      <span>Trang chủ</span> <span class="sep">|</span> <span>Giới thiệu</span>
    </section>
    ...
    <section class="container" style="margin: 40px 0; padding: 40px 0; border-top: 1px solid #eee; border-bottom: 1px solid #eee;">
      <div style="max-width: 800px; margin: 0 auto; text-align: center;">
        ...
        <div style="margin-top: 40px;">
          <a href="category.php" class="btn btn-primary" style="padding: 12px 30px; font-size: 16px;">Xem Sản Phẩm</a>
        </div>
      </div>
    </section>
